...
var coins = 0;
var total = 1;
var totalfire2 = JSON.parse(JSON.stringify(total));
var scorefire2 = JSON.parse(JSON.stringify(score));
var coinsfire2 = JSON.parse(JSON.stringify(coins));
var d;

if (JSON.parse(localStorage.getItem("savedscore2")) > 0) {
  score = JSON.parse(localStorage.getItem("savedscore2"));
...
if (JSON.parse(localStorage.getItem("savedcoin2")) > 0) {
  coins = JSON.parse(localStorage.getItem("savedcoin2"));
} else {
  coins = 0;
}

if (JSON.parse(localStorage.getItem("savedtotal2")) > 0) {
  total = JSON.parse(localStorage.getItem("savedtotal2"));
...
function game() {
  coins = coins - 1;
  localStorage.setItem("savedcoin2", JSON.stringify(coins));
  window.location.href = "/game";
  document.getElementById("game").style.display = "none";
}

function newquestion() {
  localStorage.setItem("savedtotal2", JSON.stringify(total));
  localStorage.setItem("savedscore2", JSON.stringify(score));
